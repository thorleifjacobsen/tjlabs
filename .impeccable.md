# .impeccable.md — Design Context for tjlabs.no
...
- **Theme**: Light mode. Feels right for a maker/builder browsing in daytime, on a laptop or phone. Dark mode is a future consideration but not the priority.
- **Not**: Agency-portfolio gloss (too many gradients, glow effects, oversized hero metrics). Not generic SaaS landing page energy. Not brutalist raw. Not overly playful/toy-like.
- **Yes**: Precise, crafted, a little warm. Something that feels like it was designed — not generated.
...
5. **Light with warmth** — avoid the cold blue-grey trap. The amber accent is a good instinct. Neutrals should have a very slight warm-blue tint (matching the primary hue) to feel cohesive and alive.
...
- Already using OKLCH color tokens — keep and extend this approach
- Lucide icons already in use
- Accessibility: WCAG compliance not a hard requirement, but baseline usability expected
